...
\begin{Figure}
    ...
    \begin{tikzpicture}[node distance=4cm, every text node part/.style={align=center}]
        ...
        \node (isnotpushing) [decision, right of=isaccelerating, xshift=2cm] {$P$};
        \node (setpushing) [process, right of=isnotpushing, xshift=2cm] {$P = 1$ \\ $t_0 = t$ \\ $R = 0$ \\ $\alpha_d = 0$};
        ...
        \node (ispushing) [decision, below of=isnotpushing, yshift=-2cm] {$P$};
        ...
        \draw [arrow] (isaccelerating) -- node[anchor=south] {yes} (isnotpushing);
        \draw [arrow] (isnotpushing) -- node[anchor=south] {no} (setpushing);
        \coordinate [below of=setpushing, xshift=2cm] (belowsetpushing);
        \draw [arrow] (isnotpushing.south) |- node[anchor=south west] {yes} (belowsetpushing) |- (isredlining.west);
        \draw [arrow] (setpushing) -- (isredlining);
        \draw [arrow] (isredlining) -- node[anchor=south] {yes} (setredlining);

        \draw [arrow] (isaccelerating.south) |- node[anchor=south west] {no} (ispushing.west);
        ...
        \draw [arrow] (isaccelerating.south) |- node[anchor=south west] {no} (wasredlining.west);
        \draw [arrow] (wasredlining) -- node[anchor=south] {yes} (notredlining);

        \draw [arrow] (isaccelerating.south) |- node[anchor=south west] {no} (isdecelerating.west);
