...
\section*{Results}
\begin{itemize}
    \item Velocity and acceleration data from both Redliner and SmartWheel were collected and compared
    \begin{itemize}
        \item Sample results in Figure \ref{fig:10pushgravel}
        \item Velocity traces have a Pearson-R coefficient of 0.985
        \item Acceleration traces have a Pearson-R coefficient of 0.823
    \end{itemize}
\end{itemize}
